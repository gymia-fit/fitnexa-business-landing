...
export function BusinessBenefitsSection(): React.JSX.Element {
  return (
    <section className="py-32 bg-black relative overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-6">
        <div className="text-center mb-20">
          ...
          >
            Grow Your Gym with <span className="text-blue-400">Real Demand</span>
          </motion.h2>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
              ...
              className="group inline-flex items-center gap-2 px-8 py-4 bg-blue-500 text-white font-bold text-lg rounded-full hover:bg-blue-400 transition-all hover:scale-105"
            >
